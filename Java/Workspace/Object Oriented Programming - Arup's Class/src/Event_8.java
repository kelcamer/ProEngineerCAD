...
public class Event_8 implements Comparable<Event_8> {
	...
	public Event_8(String name, int start, int end) {
		this.name = name;
		this.start = start;
		this.end = end;
	}
	...
	public boolean conflict(Event_8 e) {
    ...
    // finishes after e.
	public int compareTo(Event_8 e) {
