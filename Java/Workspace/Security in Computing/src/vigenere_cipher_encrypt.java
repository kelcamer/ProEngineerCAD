...
public class vigenere_cipher_encrypt {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		System.out.println("What file contains the text you would like to encrypt?");
		...
		String newString = offset_each_letter(text, keyword);
