...
public class DBAdapter2 {
    ...
    public static final int COL_DREAM = 1;
    public static final int COL_DATE = 2;
    public static final int COL_TIME = 3;


    public static final String[] ALL_KEYS = new String[] {"" + COL_DATE, "" + COL_TIME, "" + COL_DREAM};
    ...
    public long insertRow(String date, String time, String dream) {
		/*
		 * CHANGE 3:
		 */
    ...
    public boolean updateRow(long rowId, String date, String time, String dream) {
        String where = KEY_ROWID + "=" + rowId;
